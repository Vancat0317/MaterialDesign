package com.vancat.materialdesign.fragment;
...
import com.vancat.floatbutton.FloatingActionButton;
import com.vancat.floatbutton.FloatingActionMenu;
import com.vancat.materialdesign.R;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        programFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                programFab1.setLabelColors(ContextCompat.getColor(Objects.requireNonNull(getActivity()), R.color.grey),
